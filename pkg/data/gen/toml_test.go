...
`
  ...
  Fields:
    floatC: constant, source=0.5, count=5000, time-precision=Millisecond
    integerC: constant, source=3, count=5000, time-precision=Hour
    stringC: constant, source="hello", count=5000, time-precision=Nanosecond
    stringA: array, source=[]string{"hello", "world"}, count=5000, time-precision=Nanosecond
    boolf: constant, source=false, count=5000, time-precision=Nanosecond

  Name: random
  Tags:
    tagSeq: sequence, prefix="value%s", range=[0,100)
  Fields:
    floatR: rand<float>, seed=10, min=50.100000, max=50.100000, count=5000, time-precision=Millisecond
  ...
  Fields:
    stringA: array, source=[]string{"this", "that"}, count=1000, time-precision=Millisecond
    integerA: array, source=[]int64{5, 6, 7}, count=1000, time-precision=Millisecond
`
